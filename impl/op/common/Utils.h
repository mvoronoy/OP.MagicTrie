...
namespace OP::utils
{
    ...
    */
    ...
    template <class ...Tx>
    using tuple_merge_t = typename tuple_merge<Tx...>::type;
    ...
    */
    ...
    /** 
    * Umbrella template to iterate all types containing in the source std::tuple or std::variant and creates new type
    ...
    */
    ...
    /**
    * Allow evaluate sizeof for type (including tuples) aligned to current compiler requirements.
    *   Usage:\code
    ...
    * priority and during call provide `priority_tag<2>`.
    * For example: \code
    *   template <class T>
