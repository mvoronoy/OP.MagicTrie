        ...
        *       additional sorting instead it relies on generator function and developer responsibility
        ...
        private:
            ...
            void adaptive_start()
            {
                ...
                {
                    constexpr bool is_arg_bool_c = std::is_same_v<bool, typename ftraits_t::template arg_i <0>>;
            ...
            void adaptive_next()
            {
                ...
                if constexpr (ftraits_t::arity_c == 1)
                {
                    static_assert(std::is_same_v<bool, typename ftraits_t::template arg_i<0>>,
