...
void test_EvSrcSegmentManager(OP::utest::TestResult &tresult)
{
...
!!!!!!!!!==>*/
void test_EvSrcSegmentGenericMemoryAlloc(OP::utest::TestResult &tresult)
{
    const char seg_file_name[] = "t-segementation.test";
    GenericMemoryTest::test_MemoryManager<EventSourcingSegmentManager>(seg_file_name, tresult);

}
void test_EvSrcSegmentManagerMultithreadMemoryAllocator(OP::utest::TestResult &tresult)
{
...
void test_EvSrcMemmngrAllocDealloc(OP::utest::TestResult &tresult)
{
...
void test_EvSrcReleaseReadBlock(OP::utest::TestResult &tresult)
{
...
void test_EvSrcNestedTransactions(OP::utest::TestResult &tresult)
{
...
void test_EvSrcBlockInclude(OP::utest::TestResult &tresult)
{
    tresult.info() << "test Transacted Segment Manager..." << std::endl;
...
void test_EvSrcBlockIncludeOnRead(OP::utest::TestResult &tresult)
{
    tresult.info() << "test Transacted Segment Manager..." << std::endl;
...
void test_EvSrcBlockOverlapOnRead(OP::utest::TestResult &tresult)
{
...
//void test_EvSrcMemoryReuseFail(OP::utest::TestResult &tresult)
//{
//    tresult.info() << "test Transacted Segment Manager..." << std::endl;
//
//    const char seg_file_name[] = "t-segementation.test";
...
->declare(test_EvSrcSegmentManager, "general")
//->declare(test_FarAddress, "far address conversion")
->declare(test_EvSrcSegmentGenericMemoryAlloc, "memoryAlloc")
->declare(test_EvSrcSegmentManagerMultithreadMemoryAllocator, "multithreadAlloc")
->declare(test_EvSrcMemmngrAllocDealloc, "dealloc-alloc issue in single tran" )
->declare(test_EvSrcReleaseReadBlock, "release read block")
->declare(test_EvSrcNestedTransactions, "nested transactions")
->declare(test_EvSrcBlockInclude, "test write-block include capability")
->declare(test_EvSrcBlockIncludeOnRead, "test read-block include capability")
->declare(test_EvSrcBlockOverlapOnRead, "transaction on overlapped blocks")
;