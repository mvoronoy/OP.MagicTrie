...
void test_RangeJoin(OP::utest::TestResult &tresult)
{
    ...
    tresult.assert_true(OP::ranges::utils::key_equals(*res_src1, src1));
...
void test_FilterRange(OP::utest::TestResult &tresult)
{
    ...
    tresult.assert_true(OP::ranges::utils::key_equals(*r_src0->filter(_filter_sylable<decltype(r_src0)::element_type>), src0));
    ...
    auto r1_src1 = OP::ranges::make_iterators_range(src1);
    tresult.assert_true(OP::ranges::utils::key_equals(*r1_src1->filter(_filter_sylable<decltype(r1_src1)::element_type>), strain1));
...
void test_UnionAllRange(OP::utest::TestResult &tresult)
{
    ...
    tresult.assert_true(OP::ranges::utils::key_equals(*u1r, src_empty));
    ...
    tresult.assert_true(OP::ranges::utils::key_equals(*u2_left_empty, src1), OP_CODE_DETAILS(<<"Union-all empty-left"));
    ...
    tresult.assert_true(OP::ranges::utils::key_equals(*u2_right_empty, src1), OP_CODE_DETAILS(<< "Union-all empty-right"));
    ...
    tresult.assert_true(OP::ranges::utils::key_equals(*u1_2, strain1), OP_CODE_DETAILS(<< "Union-all with intersection"));
    ...
    tresult.assert_true(OP::ranges::utils::key_equals(*u2_1, strain1), OP_CODE_DETAILS(<< "Union-all with intersection"));
    ...
    tresult.assert_true(OP::ranges::utils::key_equals(*u1_3, strain2), OP_CODE_DETAILS(<< "Union-all no intersection"));
