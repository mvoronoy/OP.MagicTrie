...
void test_RangeJoin(OP::utest::TestResult &tresult)
{
    ...
    //}
    //);
    auto res_src1 = r1_src1.join(r2_src1, lexic_comparator_functor<decltype(r1_src1)::iterator, decltype(r2_src1)::iterator>());
...
void test_FilterRange(OP::utest::TestResult &tresult)
{
    ...
    tresult.assert_true(OP::trie::utils::key_equals(r_src0.filter(_filter_sylable<decltype(r_src0)>), src0));
    ...
    auto r1_src1 = OP::trie::make_iterators_range(src1);
    tresult.assert_true(OP::trie::utils::key_equals(r1_src1.filter(_filter_sylable<decltype(r1_src1)>), strain1));
...
void test_UnionAllRange(OP::utest::TestResult &tresult)
{
    ...
    auto u1r = r_src0.merge_all(r_src0_1, lexic_comparator_functor<decltype(r_src0)::iterator, decltype(r_src0_1)::iterator>());
    ...
    auto u2_left_empty = r_src0.merge_all(r_src1, lexic_comparator_functor<decltype(r_src0)::iterator, decltype(r_src1)::iterator>());
    tresult.assert_true(OP::trie::utils::key_equals(u2_left_empty, src1), OP_CODE_DETAILS(<<"Union-all empty-left"));

    auto u2_right_empty = r_src1.merge_all(r_src0, lexic_comparator_functor<decltype(r_src1)::iterator, decltype(r_src0)::iterator>());
    ...
    auto u1_2 = r_src1.merge_all(r_src2, lexic_comparator_functor<decltype(r_src1)::iterator, decltype(r_src2)::iterator>());
    tresult.assert_true(OP::trie::utils::key_equals(u1_2, strain1), OP_CODE_DETAILS(<< "Union-all with intersection"));

    auto u2_1 = r_src2.merge_all(r_src1, lexic_comparator_functor<decltype(r_src2)::iterator, decltype(r_src1)::iterator>());
    ...
    auto u1_3 = r_src1.merge_all(r_src3, lexic_comparator_functor<decltype(r_src1)::iterator, decltype(r_src3)::iterator>());
    tresult.assert_true(OP::trie::utils::key_equals(u1_3, strain2), OP_CODE_DETAILS(<< "Union-all no intersection"));

    auto u1_3_1 = r_src3.merge_all(r_src1, lexic_comparator_functor<decltype(r_src3)::iterator, decltype(r_src1)::iterator>());
